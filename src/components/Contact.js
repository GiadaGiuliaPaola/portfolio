        ...
        <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
          ...
          <form
            ...
            <div className="relative mb-4">
              <label
                htmlFor="message"
                className="leading-7 lg:text-left text-gray-600">
                Message
              </label>
              <textarea
                id="message"
                name="message"
                className="w-full bg-green-300 rounded border border-green-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 h-32 text-base outline-none text-gray-900 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
              />
            </div>
            <button
              type="submit"
